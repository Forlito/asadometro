    ...
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <nav className="flex items-center justify-between px-6 py-4 max-w-6xl mx-auto w-full">
        ...
        <div className="flex items-center gap-3">
          <Button
            onClick={handleLogin}
            className="rounded-lg text-sm px-5 py-2 font-semibold gap-2"
          >
        ...
        <div className="max-w-6xl mx-auto w-full grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <Button
              onClick={handleLogin}
              size="lg"
              className="rounded-lg text-base px-8 py-6 font-semibold shadow-lg mt-8 gap-2"
            >
      ...
      <section className="px-6 py-20 text-center">
        ...
        <Button
          onClick={handleLogin}
          size="lg"
          className="rounded-lg text-base px-8 py-6 font-semibold shadow-lg gap-2"
        >
          <svg viewBox="0 0 24 24" width="20" height="20" xmlns="http://www.w3.org/2000/svg">
            <path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92a5.06 5.06 0 0 1-2.2 3.32v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.1z" fill="#4285F4"/>
            <path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="#34A853"/>
